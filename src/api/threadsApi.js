...
// Use the gateway URL from runtime config or environment variables
const GATEWAY_BASE_URL = window.ENV?.VITE_API_GATEWAY_URL || import.meta.env.VITE_API_GATEWAY_URL || 'http://localhost:8000';
